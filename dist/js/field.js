...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-video-skipseconds', __webpack_require__(3));
    Vue.component('detail-nova-video-skipseconds', __webpack_require__(6));
    Vue.component('form-nova-video-skipseconds', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    chapters: function chapters(value) {
          ...
          ? _c(
              ...
              _vm._l(_vm.chapters, function(chapter, index) {
                return _c(
                  ...
                  {
                    key: index,
                    staticClass: "flex mb-1 items-center justify-between"
                  },
                  [
                        ...
                        directives: [
                          {
                            ...
                            value: chapter.seek,
                            expression: "chapter.seek",
                            modifiers: { number: true }
                          }
                        ],
                        staticClass:
                          "w-full form-control form-input form-input-bordered",
                        attrs: { type: "number", placeholder: "Sec" },
                        domProps: { value: chapter.seek },
                        on: {
                    ...
                    _c("div", { staticClass: "mr-2 w-full" }, [
                      _c("input", {
                        ...
                        domProps: { value: chapter.title },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(chapter, "title", $event.target.value)
                          }
                        }
                      })
                    ]),
                    ...
                    _c("div", [
                      _c(
                        ...
                        {
                          staticClass:
                            "text-xs btn btn-default btn-primary inline-flex items-center relative",
                          on: {
